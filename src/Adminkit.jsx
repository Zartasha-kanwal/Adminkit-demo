...
export default function Adminkit() {
  ...
  <section className="bg-[#f6f5f5]">
      {/* Sidebar */}
      <div className={`fixed top-0 left-0 h-[100vh] overflow-y-auto bg-gray-800 text-white w-64 p-5 transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out`}> 
        <ul className="space-y-4">
          <li className="hover:bg-gray-700 p-2 rounded mt-16 font-bold">AdminKit<sup className="bg-blue-600 ml-1 rounded-sm">PRO</sup></li>
          <div className="grid grid-cols-[20%_80%]">
              <div>
                <img src="https://demo.adminkit.io/img/avatars/avatar.jpg" className="rounded-sm h-[40px] w-[40px] "/>
              </div>
          ...
          <ul className="text-[#ccc] text-[16px]">Pages
            <li className="flex flex-row gap-2 mt-4 text-white"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-sliders align-middle"><line x1="4" y1="21" x2="4" y2="14"></line><line x1="4" y1="10" x2="4" y2="3"></line><line x1="12" y1="21" x2="12" y2="12"></line><line x1="12" y1="8" x2="12" y2="3"></line><line x1="20" y1="21" x2="20" y2="16"></line><line x1="20" y1="12" x2="20" y2="3"></line><line x1="1" y1="14" x2="7" y2="14"></line><line x1="9" y1="8" x2="15" y2="8"></line><line x1="17" y1="16" x2="23" y2="16"></line></svg>
             Dashboards
            </li>
            <li className="text-white hover:bg-gray-700 p-2 rounded">→<a className="ml-4" href="#">Analytics</a></li>
            <li className="text-white hover:bg-gray-700 p-2 rounded">→<a className="ml-4" href="#">E-Commerce </a></li>
            <li className="text-white hover:bg-gray-700 p-2 rounded">→<a className="ml-4" href="#">Crypto </a></li>
          </ul>
          <ul className="text-[#ccc]">
            <li className="flex flex-row gap-4 items-center hover:text-white cursor-pointer mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layout align-middle"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>
            Pages</li>
            <li className="flex flex-row gap-4 items-center hover:text-white cursor-pointer mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user align-middle"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
             Profile
            </li>
            <li className="flex flex-row gap-4 items-center hover:text-white cursor-pointer mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-credit-card align-middle"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line></svg>
             Invoice
            </li>
        ...
        <div className="w-full h-[170px] p-5 bg-[#293947] rounded-md mt-8">
         ...
         <div className="text-sm mb-6">Your weekly sales report is ready for download!</div>
         <button className="text-blue-600 border border-blue-600 w-full h-9 rounded-md">Download</button>
        </div>
      </div>
    <nav className="flex items-center justify-between bg-white shadow-lg p-4  text-white sticky top-0 z-20">
        
      {/* Menu Icon */}
      <div className="relative">
        <button className="text-3xl" onClick={() => setIsSidebarOpen(!isSidebarOpen)}>
          <FontAwesomeIcon icon={faBars} className={` text-3xl ${isSidebarOpen ? "text-[#000000A6] text-xl" : "text-[#000000A6]"} transition-colors duration-300`}  />
        </button>
      </div>
      ...
      <div className="hidden lg:flex gap-4 text-[#000000A6]">
        ...
        <div className="relative top-0 group">
          ...
          <div className="absolute left-0 mt-2 w-40 bg-white shadow-lg opacity-0 invisible translate-y-4 transition-all duration-300 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0">
             <a className="block px-4 py-2 text-[#000000A6] hover:bg-gray-200">HomePage</a>
             <a className="block px-4 py-2 text-[#000000A6] hover:bg-gray-200">Documentations</a>
             <a className="block px-4 py-2 text-[#000000A6] hover:bg-gray-200">Changelog</a>
            </div>
        </div>
      </div>
      ...
      {/* Icons */}
        <div className="flex items-center justify-center gap-4 text-[#4d4b4ba6]">
          <FontAwesomeIcon icon={faBell} className="text-xl cursor-pointer hover:text-blue-500" />
          <FontAwesomeIcon icon={faEnvelope} className="text-xl cursor-pointer hover:text-blue-500" />
          <div className="cursor-pointer">
             <img src="https://demo.adminkit.io/img/flags/us.png" className="h-[20px] w-[20px] rounded-full"  />
         </div>
         {/* Fullscreen Toggle */}
         <button onClick={toggleFullscreen}>
          <FontAwesomeIcon icon={faExpand} className="text-xl hover:text-blue-500" />
         </button>
          <img src="https://demo.adminkit.io/img/avatars/avatar.jpg" alt="Profile" className="w-10 h-10 rounded-[7px] cursor-pointer"/>
       </div>
    </nav>
      ...
      <div className=" grid md:grid-cols-2 grid-cols-1 gap-3">
        ...
        <div className="h-[154px] p-[30px] shadow-xl">
          <div className="flex flex-row items-center justify-between font-semibold">
            ...
            <span className="text-[#3b7ddd] bg-[#d3e2f7] h-8 w-8 rounded-full flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-dollar-sign align-middle"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg></span>
          </div>
      ...
      <div>
        ...
        <div className="flex justify-between items-center mt-2">
          ...
          <div className="flex flex-row gap-4">
            ...
            <input type="text" placeholder="Search.." className="text-[#939BA2] outline-0 rounded-sm px-2"/>
          </div>
        ...
        <div className="flex justify-center items-center shadow-xl">
         <div className="w-full max-w-3xl pt-2">
           <ResponsiveContainer width="100%" height={300} className={`bg-[#e9f1f4]`}>
             <LineChart data={data}>
              <XAxis dataKey="month" />
    ...
    {/*Broswer & Calender */}
    <div className="grid lg:grid-cols-2 grid-cols-1 h-1/2 px-20 gap-4 mt-10">
     {/*Broswer usage area */}
      <div className="shadow-lg bg-white">
        <h1 className="font-semibold text-[#afadad] text-lg mt-2 ml-2">Browser Usage</h1>
        <div className="flex justify-center items-center">
          <PieChart width={300} height={300}>
          <Pie data={data2} dataKey="value" cx="50%" cy="50%" outerRadius={100}>
        ...
        <div className="flex flex-row justify-between items-center px-4 border border-b-gray-400 border-x-0 border-t-0 mb-4">
          <div> <i className="fa-solid fa-circle text-blue-700"></i> Chrome <span className="text-[#1CBB8C] bg-[#1CBB8C26] rounded-sm">+12%</span></div>
          <span>4306</span>
        </div>
        <div className="flex flex-row justify-between items-center px-4 border border-b-gray-400 border-x-0 border-t-0 mb-4">
          <div> <i className="fa-solid fa-circle text-orange-500"></i> Firefox <span className="text-[#Dc3545] bg-[#DC354526] rounded-sm">-3%</span></div>
          <span>3801</span>
        </div>
        <div className="flex flex-row justify-between items-center px-4 border border-b-gray-400 border-x-0 border-t-0 mb-4">
          <div> <i className="fa-solid fa-circle text-red-600"></i>  Edge</div>
          <span>1689</span>
        </div>
        <div className="flex flex-row justify-between items-center px-4 border border-b-gray-400 border-x-0 border-t-0 mb-4">
          <div> <i className="fa-solid fa-circle text-black"></i>  Others</div>
          <span>3251</span>
        </div>
     </div>
  {/*Calender area */}
  <div className="bg-white shadow-lg">
    <div className="flex flex-row px-2 py-2 justify-between items-center">
      <h1 className="font-semibold text-[#afadad] text-lg mt-2 ml-2">Calender</h1>
      <div className="relative cursor-pointer" onClick={() => setDropdownOpen(!dropdownOpen)}><i className="fa-solid fa-ellipsis"></i>
           {dropdownOpen && (
